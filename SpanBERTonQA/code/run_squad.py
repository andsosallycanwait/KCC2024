...
def main(args):
    ...
    if torch.cuda.is_available() and not args.no_cuda:
        ...
        n_gpu = 1  # Since you're only using one 
        
    else:
        raise ValueError("CUDA is not available or --no_cuda is set. Please enable CUDA or unset --no_cuda.")
...
if __name__ == "__main__":
        ...
        parser.add_argument("--output_dir", default="/home/nilu/SpanBERT", type=str, required=True,
                            help="The output directory where the model checkpoints and predictions will be written.")
        parser.add_argument("--train_file", default="/home/nilu/SpanBERT/train_processed_data.json", type=str,
                            help="SQuAD json for training. E.g., train-v1.1.json")
        parser.add_argument("--dev_file", default="/home/nilu/SpanBERT/dev_processed_data.json", type=str,
                            help="SQuAD json for predictions. E.g., dev-v1.1.json or test-v1.1.json")
        parser.add_argument("--test_file", default="/home/nilu/SpanBERT/test_processed_data.json", type=str)
