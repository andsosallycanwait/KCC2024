...
if __name__ == '__main__':
    ...
    cleaned_ingredients = list(set(ingredient_normalizer.normalize_ingredients(ingredients_yummly)))
    ...
    cleaned_yummly_ingredients = sorted(list({elem.strip() for elem in cleaned_ingredients if len(elem.split()) <= 3 and len(elem) > 1}))
